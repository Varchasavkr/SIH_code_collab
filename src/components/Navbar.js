...
const Navbar = () => {
  return (
    <div className="relative w-full h-auto p-[1%] z-10">
      <div className="absolute left-12 w-[90%] h-15 rounded-full bg-gradient-to-r from-purple-100 via-purple-150 to-purple-300 p-5 flex justify-between shadow-2xl">
